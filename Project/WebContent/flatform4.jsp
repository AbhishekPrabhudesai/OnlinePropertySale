        ...
        <form action="imageform" method="post">
            <table>
                <tbody>
                    <tr>
                        <td>Image1</td>
                        <td><input type="file" name="imgImages"></td>
                    </tr>
                    <!-- <tr>
                        <td>Image2</td>
                    ...
                    <tr>
                        <td>Area</td>
                        <td><input type="text" name="P_AREA"></td>
                    </tr>
                    <tr>
                        <td>Price</td>
                    ...
                    <tr>
                        <td>PIN</td>
                        <td><input type="number" name="P_PIN"></td>
                    </tr>
                    <tr>
                        <td>Number of Rooms</td>
                        <td><input type="number" name="FL_ROOMS"></td>
                    </tr>
                    <tr>
                        <td>Number of Bedrooms</td>
                        <td><input type="number" name="FL_BEDROOMs"></td>
                    </tr>
                    <tr>
                        <td>Number of Balconies</td>
                        <td><input type="number" name="FL_BALCONIES"></td>
                    </tr>
                    <tr>
                        <td>Furnish State</td>
                        <td><input type="radio" name="FL_FURNISH_STATE">Not Furnished</td>
                    </tr>
                    <tr><td></td>
                        <td><input type="radio" name="FL_FURNISH_STATE">Semi Furnished</td>
                    </tr>
                    <tr><td></td>
                        <td><input type="radio" name="FL_FURNISH_STATE">Fully Furnished</td>
                    </tr>
                    <tr>
                        <td>Car Parking Facility</td>
                        <td><input type="radio" name="FL_CAR_PARK">No</td>
                    </tr>
                    <tr><td></td>
                        <td><input type="radio" name="FL_CAR_PARK">Yes</td>
                    </tr>
                    <tr>
                        <td>Lift Facility</td>
                        <td><input type="radio" name="FL_LIFT">No</td>
                    </tr>
                    <tr><td></td>
                        <td><input type="radio" name="FL_LIFT">Yes</td>
                    </tr>
                    <tr>
                        <td>Documents</td>
                        <td><input type="file" name="P_DOCUMENT"></td>
                    </tr> -->
