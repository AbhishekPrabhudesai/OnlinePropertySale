...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
 ...
 <!--                
                    ...
                    <div class="blog-masonry masonry-true">
                        <div class="post-masonry col-md-4 col-sm-6">
                            <div class="blog-thumb">
                                <img src="images/f1.jpg" alt="" style="height:200px;">
                                <div class="overlay-b">
                              ...
                              <div class="blog-body" >
                                <div class="box-content">
                                 <span class="blog-meta" style=" font-size:20px; color:black"><b>3 BHK</b></span>
                                    <p>Gangadham socity.</p>
                                    <p>C wing ,flat no 1001</p>
                                    <p>market yard pune.</p>
                                    <br/>
                                    <p><b style="font-size:20px; color:black">price 38 lac.</b></p>
                        ...
                        <div class="post-masonry col-md-4 col-sm-6">
                            <div class="blog-thumb">
                                <img src="images/f2.jpg" alt="" style="height:200px;">
                                <div class="overlay-b">
                                   </div>
                            </div>
                              ...
                              <div class="blog-body" >
                                <div class="box-content">
                                 <span class="blog-meta" style=" font-size:20px; color:black"><b>2 BHK</b></span>
                                    <p>Pinakanand Residancy.</p>
                                    <p>Ground floor ,flat no 20</p>
                                    <p>Karve nagr, pune.</p>
                                    <br/>
                                    <p><b style="font-size:20px; color:black">price 76 lac.</b></p>
                        ...
                        <div class="post-masonry col-md-4 col-sm-6">
                            <div class="blog-thumb">
                                <img src="images/f3.jpg" alt="" style="height:200px;">
                                <div class="overlay-b">
                              ...
                              <div class="blog-body" >
                                <div class="box-content">
                                 <span class="blog-meta" style=" font-size:20px; color:black"><b>2 BHK</b></span>
                                    <p>Gangadham socity.</p>
                                    <p>NIBM colony ,flat no 258</p>
                                    <p>Kondwa pune.</p>
                                    <br/>
                                    <p><b style="font-size:20px; color:black">price 75 lac.</b></p>
                        ...
                        <div class="post-masonry col-md-4 col-sm-6">
                            <div class="blog-thumb">
                                <img src="images/f4.jpg" alt="" style="height:200px;">
                                <div class="overlay-b">
                              ...
                              <div class="blog-body" >
                                <div class="box-content">
                                 <span class="blog-meta" style=" font-size:20px; color:black"><b>3 BHK</b></span>
                                    <p>Gangadham socity.</p>
                                    <p>A wing ,flat n0 148</p>
                                    <p>Maharshi nagar, pune.</p>
                                    <br/>
                                    <p><b style="font-size:20px; color:black">price 1.5 cr.</b></p>
                        ...
                        <div class="post-masonry col-md-4 col-sm-6">
                            <div class="blog-thumb">
                                <img src="images/f5.jpg" alt="" style="height:200px;">
                                <div class="overlay-b">
                                    <div class="overlay-inner">
                              ...
                              <div class="blog-body" >
                                <div class="box-content">
                                 <span class="blog-meta" style=" font-size:20px; color:black"><b>2 BHK</b></span>
                                    ...
                                    <p>market yard pune.</p>
                                    <br/>
                                    <p><b style="font-size:20px; color:black">price 78 lac.</b></p>
                        ...
                        <div class="post-masonry col-md-4 col-sm-6">
                            <div class="blog-thumb">
                                <img src="images/f6.jpg" alt="" style="height:200px;">
                                <div class="overlay-b">
                                    <div class="overlay-inner">
                              ...
                              <div class="blog-body" >
                                <div class="box-content">
                                 <span class="blog-meta" style=" font-size:20px; color:black"><b>3 BHK</b></span>
                                    <p>Sankalp building.</p>
                                    <p>Katemali buildig</p>
                                    <p>Camp pune.</p>
                                    <br/>
                                    <p><b style="font-size:20px; color:black">price 50 lac.</b></p>
                              ...
                              <div class="blog-body" >
                                <div class="box-content">
                                 <span class="blog-meta" style=" font-size:20px; color:black"><b>2 BHK</b></span>
                                    ...
                                    <p>market yard pune.</p>
                                    <br/>
                                    <p><b style="font-size:20px; color:black">price 45 lac.</b></p>
                        ...
                        <div class="post-masonry col-md-4 col-sm-6">
                            <div class="blog-thumb">
                              ...
                              <div class="blog-body" >
                                <div class="box-content">
                                 <span class="blog-meta" style=" font-size:20px; color:black"><b>2 BHK</b></span>
                                    <p>Aradhana apartment.</p>
                                    <p>3rd floor ,flat no 23</p>
                                    <p>market yard pune.</p>
                                    <br/>
                                    <p><b style="font-size:20px; color:black">price 75 lac.</b></p>
                            ...
                            <div class="blog-thumb">
                              ...
                              <div class="blog-body" >
                                <div class="box-content">
                                 <span class="blog-meta" style=" font-size:20px; color:black"><b>2 BHK</b></span>
                                    <p>Anand Recidancy</p>
                                    <p>D wing,flat no 125</p>
                                    <p>Hinjawadi park</p>
                                    <br/>
                                    <p><b style="font-size:20px; color:black">price 68 lac.</b></p>
        ...
        <!-- ------------------------------------------------------------------------------------------ -->
         ...
         <!--------------------------------------------------------------------------------------------->
          <!--------------------------------------------------------------------------------------------->
           <!-- <div id="showagri" style="display:block"> -->
           <c:set var="count" value="0" scope="page"/>
           <div class="row">  
              <div class="blog-masonry masonry-true">
                    <c:forEach var="allAgridetails"  items="${allAgridetails}">
                        <div class="post-masonry col-md-4 col-sm-6">
                            <div class="blog-thumb">
                                <img src="images/ag${count}.jpg" alt="" style="height:200px;">
                              ...
                              <div class="blog-body" >
                                <div class="box-content">
                                 <span class="blog-meta" style=" font-size:20px; color:black"><b>${allAgridetails.propertyDetails.PArea} Acres</b></span>
                                   <p>Property ID:${allAgridetails.propertyDetails.PId}</p>
                            <p>Type of Property     : ${allAgridetails.propertyDetails.PType}</p>
                            <p>Property Area        : ${allAgridetails.propertyDetails.PArea}</p>
                            <p>Property Price       : ${allAgridetails.propertyDetails.PPrice}</p>
                            <%-- <p>Property Sold Status : ${allAgridetails.propertyDetails.PSoldStatus}</p> --%>
                            <p>Property Address     : ${allAgridetails.propertyDetails.PAddress}</p>
                            <p>Property Document    : ${allAgridetails.propertyDetails.PDocument}</p>
                            <p>Water Source Availability: ${allAgridetails.alWaterSource}</p> 
                            <p>Property Owner Name  : ${allAgridetails.propertyDetails.customerDetails.CName}</p>
                            <p>Property Owner Surname  : ${allAgridetails.propertyDetails.customerDetails.CSurname}</p>
                            <p>Property Owner Ph No  : ${allAgridetails.propertyDetails.customerDetails.CMobile}</p>
                                    <br/>
     ...
     <!--------------------------------------------------------------------------------------------->               
      <!--------------------------------------------------------------------------------------------->
                        ...
                        <div class="box-content">
                            ...
                            <c:choose>
                            	<c:when test="${allAgridetails.propertyDetails.PId == allimage.propertyDetails.PId}">
							        <p>${allimage.imgImages}</p>
							        <img alt="img" src="data:image/jpeg;base64,${allimage.imgImages}"/>
							        <img src="data:image/jpg;base64,${allimage.imgImages}" alt="No image">
							        <%
     ...
     <!--------------------------------------------------------------------------------------------->               
      <!--------------------------------------------------------------------------------------------->
                        ...
                        <div class="box-content">
                            ...
                            <p>${allimage.PArea}</p>
                            <p>${allimage.PPrice}</p>
                            <p>${allimage.PSoldStatus}</p>
                            <p>${allimage.PAddress}</p>
                            <p>${allimage.PDocument}</p>
